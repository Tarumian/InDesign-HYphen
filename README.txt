...
2. Երկու անգամ կտտացրեք "install.bat" ֆայլի վրա:
3. Թույլատրեք Ադմինիստրատորի հարցումը (UAC -> Yes):
4. Տեղադրիչը ավտոմատ կտեղադրի հայերեն տողադարձման բառարանը:
...
5. Տեքստը նշեք, Character վահանակում լեզուն դրեք "Armenian", իսկ Paragraph վահանակում միացրեք "Hyphenate" նշիչը:

ՀԵՌԱՑՆԵԼՈՒ ՀԱՄԱՐ.
Աշխատեցրեք "uninstall.bat" ֆայլը:
